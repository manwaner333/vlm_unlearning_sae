...
def generate_original_outputs(model, processor, directory, label, max_token=306):
    ...
    res_file = f"{directory}/color_original_model_outputs.json"
    ...
    conversation = [
        ...
        "role": "user",
        "content": [
            {"type": "text", "text": "Please describe the objects in the image and their corresponding colors."},  # "What are these?"
            {"type": "image"},
            ],
        },
    ]
