...
def generate_original_outputs(model, processor, directory, label, max_token=306):
    ...
    res_file = f"{directory}/material_original_model_outputs.json"
    ...
    conversation = [
        ...
        "role": "user",
        "content": [
            {"type": "text", "text": "Please determine the primary material of the item shown in the image by selecting one of the following categories: [wood, metal, plastic, glass, fabric, paper, ceramic, leather, concrete, stone]."},  # "What are these?"
            {"type": "image"},
            ],
        },
    ]
