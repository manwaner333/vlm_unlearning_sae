...
def generate_original_outputs(model, processor, directory, label, max_token=306):
    ...
    res_file = f"{directory}/emotion_original_model_outputs.json"
    ...
    conversation = [
        ...
        "role": "user",
        "content": [
            {"type": "text", "text": "Please identify the category that best describes the facial expressions of the characters in the image from the following options:[happy, sad, angry, surprised, scared, disgusted, excited, relaxed, confused, bored]."},  # "What are these?"
            {"type": "image"},
            ],
        },
    ]
