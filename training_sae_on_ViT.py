...
cfg = ViTSAERunnerConfig(
    ...
    image_width = 224,
    image_height = 224,
    model_name = "Llama-3.2-11B-Vision-Instruct",   # "llava-hf/llava-v1.6-vicuna-7b-hf",  # "openai/clip-vit-large-patch14", "llava-1.5-7b-hf"
    module_name = "resid",
    block_layer = -2,
    ...
    n_batches_in_store = 1, # 4, # 15,  这个值在config.py中用于生成store_size，这是模型中实际使用的数据量。
